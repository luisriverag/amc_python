...
| Media prototype | File discovery/facts and PCM WAV/FLAC/AIFF duration/bitrate | File, WAV, FLAC, AIFF, bounds, filtering, recursive, and atomic CLI tests | Moderate for stated subset |
