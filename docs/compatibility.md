...
| Loans | prototype | Source-derived atomic single- and multi-movie check-out/check-in using the current borrower field; synthetic service/CLI/GUI tests | Add borrower lists, grouped media behavior, and explicitly configured history logging |
