...
type
  ...
  private
    ...
    function GetClipboardCommands: TAntJvClipboardCommands;
...
function THiddenPopupObject.GetClipboardCommands: TAntJvClipboardCommands;
const
...
begin
  ...
  begin
    ...
    for I := 0 to SizeOf(Integer) * 8 - 1 do
      if I in Value then
        Include(Result, TAntJvClipboardCommand(I));
  end
  else
