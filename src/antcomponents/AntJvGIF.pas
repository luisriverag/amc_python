...
begin
  ...
  GifError('Wrong number of colors; must be a power of 2');
end;
        ...
        try
          ...
          begin
            ...
            begin
              ...
              GifError('GIF code size not in range 2 to 9');
          end;
              ...
              begin
                ...
                begin
                  ...
                  begin
                    ...
                    GifError('GIF encoded data is corrupt');
                end;
...
begin
  ...
  case BI^.biBitCount of
    ...
    GifError('GIF image encoding error');
  end;
  FInterlaced := False;
    ...
    try
      ...
      with Result do
        ...
        begin
          ...
          GifError(Format('Unrecognized extension block: %.2x', [ExtensionLabel]));
    except
      Result.Free;
      raise;
    end;
              ...
              begin
                ...
                begin
                  if FComment.Count > 0 then
                    FComment.Add(sLineBreak+sLineBreak);
...
begin
  GifError('Cannot change the Size of a GIF image');
end;
...
initialization
  ...
  TPicture.RegisterFileFormat('gif', 'CompuServe GIF Image', TJvGIFImage);
